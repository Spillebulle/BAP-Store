...
fn updates_come_from_check_update_and_the_installed_rows() {
    ...
    assert_eq!(
        ...
        [
            ...
            ("bap-store", Some("0.1.0-1.fc40"), "0.2.0-1.fc40"),
...
fn updates_from_dnf5_skip_obsoleted_rows() {
    ...
    assert_eq!(
        rows,
        [
            ("bap-store", Some("0.1.0-1.fc40"), "0.2.0-1.fc41"),
...
fn check_update_output_parses_in_both_generations() {
    ...
    assert_eq!(
        ...
        [
            ...
            ("bap-store", "x86_64", "0.2.0-1.fc40", "bap"),
    ...
    assert_eq!(
        names,
        ["bap-store", "gimp", "kernel", "new-thing", "vim-enhanced"]
    );
